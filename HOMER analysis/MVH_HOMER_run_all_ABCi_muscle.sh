...
INDIR="/Users/hunterm/Documents/bash_scripts/homer/HOMER_Visium/ABC/ABC_interface/compare_w_muscle/" # folder with input files
INFILE="interface_markers_all_muscle_ABC.txt" # file with DE genes of interest, ENSDARG ID's in first column

OUTDIR="/Users/hunterm/Desktop/" # base directory for outputs
TSTAMP=$(date +"homer_results_%Y%m%d_%H%M%S_ABCi_all_muscle/") # time stamp for outputs
