...
INDIR="/Users/hunterm/Documents/bash_scripts/homer/HOMER_singlecell/EF_interfacetumor/" # folder with input files
INFILE="EF_interfacetumor_markers_all_homer.txt" # file with DE genes of interest, ENSDARG ID's in first column

OUTDIR="/Users/hunterm/Documents/bash_scripts/homer/HOMER_singlecell/EF_interfacetumor/" # base directory for outputs
TSTAMP=$(date +"homer_results_%Y%m%d_%H%M%S_EFinterfacetumor_all/") # time stamp for outputs
